...
export function AuthScreen() {
  ...
  async function submit() {
    if (!supabase || !email.trim() || password.length < 6 || (mode === 'register' && !name.trim())) { setMessage('Lengkapi data. Password minimal 6 karakter.'); return; }
